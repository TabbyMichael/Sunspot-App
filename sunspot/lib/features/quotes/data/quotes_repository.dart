    ...
    try {
      ...
      final mockQuotes = [
        Quote(
          ...
          expiresAt: DateTime.now().add(const Duration(days: 27)),
          notes:
              '5kW residential system with battery backup. Customer interested in solar + storage solution.',
        ),
        Quote(
          id: '2',
          customerName: 'Sarah Johnson',
          ...
          expiresAt: DateTime.now().add(const Duration(days: 23)),
          notes:
              '10kW commercial system for office building. Installation scheduled for next month.',
        ),
        Quote(
          id: '3',
          customerName: 'Mike Davis',
          ...
          expiresAt: DateTime.now().add(const Duration(days: 20)),
          notes:
              '3kW system - roof not suitable for installation. Recommended alternative: ground-mounted system.',
        ),
      ];

      final quote = mockQuotes.firstWhere(
        (q) => q.id == id,
        orElse: () => mockQuotes.first,
      );
