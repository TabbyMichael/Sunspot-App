...
void main() {
  test('emits filtered products for category fetch', () async {
    ...
    final expected = expectLater(
      ...
      emitsInOrder([
        ...
        isA<ProductsLoaded>()
            ...
            .having((state) => state.products.first.category, 'category', 'Batteries'),
      ]),
    );

    bloc.add(const FetchProducts(category: 'Batteries'));
